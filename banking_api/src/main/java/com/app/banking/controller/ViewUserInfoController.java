...
public class ViewUserInfoController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("<form action='editUserInfo' method='post'>");
			out.print("<article>");
			...
			out.print("<input class='userModifyInput' type='text' name='password' value='");
			...
			out.print("<tr><th>User Role</th><td><select name='roleid'>");
