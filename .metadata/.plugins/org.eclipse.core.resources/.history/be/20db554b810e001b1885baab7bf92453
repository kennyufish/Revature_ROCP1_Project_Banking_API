...
public class AddUserAccountController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.print("<input class='userModifyInput' type='text' name='username' placeholder='Username' required /></td></tr>");
			
			out.print("<tr><th>User Password</th><td>");
			out.print("<input class='userModifyInput' type='password' name='password' placeholder='Password' required /></td></tr>");
			
			out.print("<tr><th>User First Name</th><td>");
			out.print("<input class='userModifyInput' type='text' name='firstName' placeholder='First Name' required /></td></tr>");
			
			out.print("<tr><th>User Last Name</th><td>");
			out.print("<input class='userModifyInput' type='text' name='lastName' placeholder='Last Name' required /></td></tr>");
			
			out.print("<tr><th>User Email</th><td>");
			out.print("<input class='userModifyInput' type='text' name='email' placeholder='Email' required /></td></tr>");
			...
			out.print("<input class='userModifyInput' style='width:90%' type='number' min='0' step='0.01' name='initialDeposit' placeholder='Initail Deposit' required /></span></td></tr>");
			...
			out.print("<input class='userModifyInput' type='number' min='0' name='userId' placeholder='User Id' required /></td></tr>");
			out.print("<tr><th>Account Type</th><td><select style='width:100%' name='typeId' required >");
			out.print("<option value='' selected disabled hidden>Choose Type</option>");
			out.print("<option value='1' >Checking</option>");
			out.print("<option value='2' >Savings</option>");
